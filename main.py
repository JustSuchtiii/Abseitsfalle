...
async def status():
  team_list = ["FCA", "FCU", "BOC", "SVW", "SVD", "BVB", "SGE", "SCF", "HDH", "TSG", "KOE", "RBL", "B04", "M05", "BMG", "FCB", "VFB", "WOB", "BSC", "EBS", "F95", "ELV", "SGF", "HSV", "H96", "FCK", "KSC", "KSV", "FCM", "FCN", "OSN", "SCP", "FCH", "S04", "STP", "WIE"]
